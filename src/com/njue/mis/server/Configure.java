...
public class Configure {
	...
	public final static String DiscountController = "rmi://"+IP+"/DiscountController";
	public final static String SalesController = "rmi://"+IP+"/SalesController";
	public final static String RoleController = "rmi://"+IP+"/RoleController";
	public final static String UserController = "rmi://"+IP+"/UserController";
